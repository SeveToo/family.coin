          ...
          <div className="card-body p-6 sm:p-8">
            ...
            <div className="grid gap-6">
              {loading ? (
                ...
                <div className="text-center opacity-40 py-10 italic">Brak ustalonych zasad...</div>
              ) : (
                rules.map((rule, i) => (
                  <div key={rule.id} className="group relative bg-base-100/10 p-5 rounded-2xl border border-white/5 hover:border-warning/30 transition-all duration-300">
